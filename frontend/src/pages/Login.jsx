...
/* Mini card preview for left panel */
const PREVIEW_CARDS = [
  { tag: "TECH",    color: "#3B82F6", headline: "Breakthrough in Quantum Computing",      date: "Apr 22" },
  { tag: "HEALTH",  color: "#14B8A6", headline: "5 Proven Tips for Better Mornings",       date: "Apr 22" },
  { tag: "FINANCE", color: "#F59E0B", headline: "Fed Signals Rate Pause Amid Inflation",   date: "Apr 22" },
];
...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFF", display: "flex", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      {/* ── Left brand panel ─────────────────────────────── */}
      <div style={{ display: "none", width: "45%", background: "#fff", borderRight: "1px solid rgba(0,0,0,0.07)", padding: "48px", flexDirection: "column", justifyContent: "space-between", position: "relative", overflow: "hidden" }}
        className="lg-panel">

        {/* Soft bg blobs */}
        <div style={{ position: "absolute", top: "-80px", right: "-80px", width: "400px", height: "400px", borderRadius: "50%", background: "radial-gradient(circle, rgba(99,102,241,0.08) 0%, transparent 60%)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "10%", left: "-60px", width: "300px", height: "300px", borderRadius: "50%", background: "radial-gradient(circle, rgba(59,130,246,0.07) 0%, transparent 60%)", pointerEvents: "none" }} />
        ...
        <p style={{ fontSize: "12px", color: "#CBD5E1", position: "relative" }}>© {new Date().getFullYear()} AI Newsletter</p>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "32px" }}>
        ...
        >
          ...
          {/* Logo (visible on mobile / all widths since left panel is CSS-hidden) */}
          <motion.div variants={fadeIn} transition={{ duration: 0.4 }} style={{ marginBottom: "40px" }}>
          ...
          <motion.div variants={fadeUp} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }} style={{ marginBottom: "28px" }}>
            ...
            <p style={{ fontSize: "14px", color: "#94A3B8" }}>Sign in to your account</p>
          </motion.div>
          ...
          <motion.div variants={fadeUp} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", height: "46px", borderRadius: "12px", background: "#fff", border: "1px solid rgba(0,0,0,0.12)", fontSize: "14px", fontWeight: 600, color: "#0F172A", cursor: "pointer", marginBottom: "20px", transition: "box-shadow 0.2s" }}
            >
              <GoogleIcon />
          ...
          {/* Form */}
          <motion.form variants={{ show: { transition: { staggerChildren: 0.08 } } }} onSubmit={handleEmail}>

            <motion.div variants={fadeUp} transition={{ duration: 0.5 }} style={{ marginBottom: "16px" }}>
              ...
              <input
                ...
                required
                style={{ width: "100%", height: "46px", borderRadius: "11px", border: "1px solid rgba(0,0,0,0.12)", padding: "0 14px", fontSize: "14px", color: "#0F172A", background: "#fff", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s, box-shadow 0.2s" }}
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }} style={{ marginBottom: "20px" }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  required
                  style={{ width: "100%", height: "46px", borderRadius: "11px", border: "1px solid rgba(0,0,0,0.12)", padding: "0 42px 0 14px", fontSize: "14px", color: "#0F172A", background: "#fff", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s, box-shadow 0.2s" }}
                  onFocus={e => { e.target.style.borderColor = "#6366F1"; e.target.style.boxShadow = "0 0 0 3px rgba(99,102,241,0.1)"; }}
                  onBlur={e => { e.target.style.borderColor = "rgba(0,0,0,0.12)"; e.target.style.boxShadow = "none"; }}
                />
      ...
      {/* ── Inline style to show left panel on lg screens ── */}
      <style>{`
